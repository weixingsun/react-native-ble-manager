...
static NSString * const ServiceUUIDString1 = @"1800";
static NSString * const ServiceUUIDString2 = @"180A";
static NSString * const CharacteristicReadUUIDString1  = @"003784CF-F7E3-55B4-6C4C-111111111111";
static NSString * const CharacteristicWriteUUIDString1 = @"D44BC439-ABFD-45A2-B575-111111111111";
static NSString * const CharacteristicWriteUUIDString2 = @"D44BC439-ABFD-45A2-B575-111111111111";
/*
...
- (void)centralManager:(CBCentralManager *)central didDiscoverPeripheral:(CBPeripheral *)peripheral advertisementData:(NSDictionary<NSString *,id> *)advertisementData RSSI:(NSNumber *)RSSI {
    ...
    //if (![self.discoveredPeripherals containsObject:peripheral]) {
        [self.discoveredPeripherals setValue:peripheral forKey:[peripheral uuidAsString]];
    //}
    // 找到设备的回调
    if (self.delegate && [self.delegate respondsToSelector:@selector(centralTool:findAPeripheral:)]) {
        [self.delegate centralTool:self findAPeripheral:[peripheral copy]];
    }
}
